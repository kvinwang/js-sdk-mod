...
class Contract extends _Base.Base {
  ...
  #read = (messageOrId, _ref3, params) => {
    ...
    return {
      ...
      send: this._decorateMethod(origin => this.api.rx.call.contractsApi.call(origin, this.address, value, this.#getGas(gasLimit, true), storageDepositLimit, message.toU8a(params)).pipe((0, _rxjs.map)(_ref4 => {
        let {
          debugMessage,
          gasConsumed,
          gasRequired,
