...
// src/lib/hex.ts
var import_crypto_browserify = require("crypto-browserify");
...
var import_crypto_browserify2 = require("crypto-browserify");
var import_util = require("@polkadot/util");
var ALGO = "aes-256-gcm";
var AUTH_TAG_LENGTH = 32;
var toU8a = (param) => {
  if (typeof param === "string") {
    param = (0, import_util.hexAddPrefix)(param);
    return (0, import_util.hexToU8a)(param);
  }
  return param;
};
var encrypt = (data, key, iv) => {
  data = (0, import_util.hexStripPrefix)(data);
  const cipher = (0, import_crypto_browserify2.createCipheriv)(ALGO, toU8a(key), toU8a(iv));
  const enc = cipher.update(data, "hex", "hex");
  cipher.final();
  return `${enc}${cipher.getAuthTag().toString("hex")}`;
};
var decrypt = (enc, key, iv) => {
  enc = (0, import_util.hexStripPrefix)(enc);
  const decipher = (0, import_crypto_browserify2.createDecipheriv)(ALGO, toU8a(key), toU8a(iv));
  const authTag = (0, import_util.hexToU8a)((0, import_util.hexAddPrefix)(enc.slice(-AUTH_TAG_LENGTH)));
...
// src/proto/index.js
var $protobuf = __toESM(require("protobufjs/minimal"), 1);
...
var pruntime_rpc = $root.pruntime_rpc = (() => {
  ...
  pruntime_rpc2.PhactoryInfo = function() {
    ...
    PhactoryInfo.encode = function encode(message, writer) {
      ...
      if (message.gatekeeper != null && Object.hasOwnProperty.call(message, "gatekeeper"))
        $root.pruntime_rpc.GatekeeperStatus.encode(message.gatekeeper, writer.uint32(114).fork()).ldelim();
      ...
      if (message.memoryUsage != null && Object.hasOwnProperty.call(message, "memoryUsage"))
        $root.pruntime_rpc.MemoryUsage.encode(message.memoryUsage, writer.uint32(146).fork()).ldelim();
      ...
      if (message.networkStatus != null && Object.hasOwnProperty.call(message, "networkStatus"))
        $root.pruntime_rpc.NetworkStatus.encode(message.networkStatus, writer.uint32(178).fork()).ldelim();
      if (message.system != null && Object.hasOwnProperty.call(message, "system"))
        $root.pruntime_rpc.SystemInfo.encode(message.system, writer.uint32(186).fork()).ldelim();
      return writer;
    };
    ...
    PhactoryInfo.verify = function verify(message) {
      ...
      if (message.networkStatus != null && message.hasOwnProperty("networkStatus")) {
        let error = $root.pruntime_rpc.NetworkStatus.verify(message.networkStatus);
        if (error)
  ...
  pruntime_rpc2.SystemInfo = function() {
    ...
    SystemInfo.encode = function encode(message, writer) {
      ...
      if (message.gatekeeper != null && Object.hasOwnProperty.call(message, "gatekeeper"))
        $root.pruntime_rpc.GatekeeperStatus.encode(message.gatekeeper, writer.uint32(34).fork()).ldelim();
  ...
  pruntime_rpc2.InitRuntimeResponse = function() {
    ...
    InitRuntimeResponse.encode = function encode(message, writer) {
      ...
      if (message.attestation != null && Object.hasOwnProperty.call(message, "attestation"))
        $root.pruntime_rpc.Attestation.encode(message.attestation, writer.uint32(42).fork()).ldelim();
      return writer;
    };
  ...
  pruntime_rpc2.Attestation = function() {
    ...
    Attestation.encode = function encode(message, writer) {
      ...
      if (message.payload != null && Object.hasOwnProperty.call(message, "payload"))
        $root.pruntime_rpc.AttestationReport.encode(message.payload, writer.uint32(26).fork()).ldelim();
  ...
  pruntime_rpc2.ContractQueryRequest = function() {
    ...
    ContractQueryRequest.encode = function encode(message, writer) {
      ...
      if (message.signature != null && Object.hasOwnProperty.call(message, "signature"))
        $root.pruntime_rpc.Signature.encode(message.signature, writer.uint32(18).fork()).ldelim();
      return writer;
    };
  ...
  pruntime_rpc2.Signature = function() {
    ...
    Signature.encode = function encode(message, writer) {
      ...
      if (message.signedBy != null && Object.hasOwnProperty.call(message, "signedBy"))
        $root.pruntime_rpc.Certificate.encode(message.signedBy, writer.uint32(10).fork()).ldelim();
  ...
  pruntime_rpc2.WorkerState = function() {
    ...
    WorkerState.encode = function encode(message, writer) {
      ...
      if (message.benchState != null && Object.hasOwnProperty.call(message, "benchState"))
        $root.pruntime_rpc.BenchState.encode(message.benchState, writer.uint32(26).fork()).ldelim();
      if (message.miningState != null && Object.hasOwnProperty.call(message, "miningState"))
        $root.pruntime_rpc.MiningState.encode(message.miningState, writer.uint32(34).fork()).ldelim();
      ...
      if (message.tokenomicInfo != null && Object.hasOwnProperty.call(message, "tokenomicInfo"))
        $root.pruntime_rpc.TokenomicInfo.encode(message.tokenomicInfo, writer.uint32(82).fork()).ldelim();
      if (message.stat != null && Object.hasOwnProperty.call(message, "stat"))
        $root.pruntime_rpc.WorkerStat.encode(message.stat, writer.uint32(90).fork()).ldelim();
      return writer;
    };
  ...
  pruntime_rpc2.HandoverChallengeResponse = function() {
    ...
    HandoverChallengeResponse.encode = function encode(message, writer) {
      ...
      if (message.attestation != null && Object.hasOwnProperty.call(message, "attestation"))
        $root.pruntime_rpc.Attestation.encode(message.attestation, writer.uint32(18).fork()).ldelim();
      return writer;
    };
  ...
  pruntime_rpc2.TokenomicInfo = function() {
    ...
    TokenomicInfo.encode = function encode(message, writer) {
      ...
      if (message.stat != null && Object.hasOwnProperty.call(message, "stat"))
        $root.pruntime_rpc.TokenomicStat.encode(message.stat, writer.uint32(170).fork()).ldelim();
      return writer;
    };
  ...
  pruntime_rpc2.NetworkStatus = function() {
    ...
    NetworkStatus.encode = function encode(message, writer) {
      ...
      if (message.config != null && Object.hasOwnProperty.call(message, "config"))
        $root.pruntime_rpc.NetworkConfig.encode(message.config, writer.uint32(18).fork()).ldelim();
      return writer;
    };
    ...
    HttpRequest.encode = function encode(message, writer) {
      ...
      if (message.headers != null && message.headers.length)
        for (let i = 0; i < message.headers.length; ++i)
          $root.pruntime_rpc.HttpHeader.encode(message.headers[i], writer.uint32(26).fork()).ldelim();
  ...
  pruntime_rpc2.HttpResponse = function() {
    ...
    HttpResponse.encode = function encode(message, writer) {
      ...
      if (message.headers != null && message.headers.length)
        for (let i = 0; i < message.headers.length; ++i)
          $root.pruntime_rpc.HttpHeader.encode(message.headers[i], writer.uint32(18).fork()).ldelim();
      if (message.body != null && Object.hasOwnProperty.call(message, "body"))
...
var create = async ({ api, baseURL, contractId, autoDeposit = false }) => {
  ...
  const remotePubkey = (0, import_util2.hexAddPrefix)(publicKey);
  const seed = (0, import_util2.hexToU8a)((0, import_util2.hexAddPrefix)(randomHex(32)));
  ...
  const commandAgreementKey = (0, import_wasm_crypto.sr25519Agree)((0, import_util2.hexToU8a)(contractKey), sk);
  const createEncryptedData = (data, agreementKey) => {
    const iv = (0, import_util2.hexAddPrefix)(randomHex(12));
    return {
      iv,
      pubkey: (0, import_util2.u8aToHex)(pk),
      data: (0, import_util2.hexAddPrefix)(encrypt(data, agreementKey, (0, import_util2.hexToU8a)(iv)))
    };
  };
  const query = async (encodedQuery, { certificate, pubkey, secret }) => {
    ...
    return pruntimeApi.contractQuery(requestData).then((res) => {
      ...
      return (0, import_util2.hexAddPrefix)(data);
    });
  };
  ...
  const txContracts = (dest, value, gas, storageDepositLimit, encParams) => {
    let deposit = 0;
    debugger;
    console.log("txContracts gas:", gas, gas.refTime);
    if (autoDeposit) {
      // FIXME: use BN.js
...
var signCertificate = async (params) => {
  ...
  const { api } = params;
  const generatedSeed = (0, import_util3.hexToU8a)((0, import_util3.hexAddPrefix)(randomHex(32)));
  ...
  const encodedCertificateBody = api.createType("CertificateBody", {
    pubkey: (0, import_util3.u8aToHex)(pubkey),
    ttl: 2147483647,
    config_bits: 0
  }).toU8a();
  let signerPubkey;
  ...
  if (isUsingSigner(params)) {
    ...
    signerPubkey = (0, import_util3.u8aToHex)((0, import_util_crypto.decodeAddress)(address));
    if (!signatureType) {
      signatureType = getSignatureTypeFromAccount(account);
    }
    const signerResult = await ((_a = signer.signRaw) == null ? void 0 : _a.call(signer, {
      address,
      data: (0, import_util3.u8aToHex)(encodedCertificateBody),
      type: "bytes"
    }));
    if (signerResult) {
      signature = (0, import_util3.hexToU8a)(signerResult.signature);
    } else {
      throw new Error("Failed to sign certificate");
    }
  } else {
    const { pair } = params;
    signerPubkey = (0, import_util3.u8aToHex)(pair.publicKey);
    if (!signatureType) {
